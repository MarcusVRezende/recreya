          ...
          <div className="init-hidden">
            <div className="texto-foto-container">
              <p className="texto-foto">
                ...
                voluptates ipsum doloremque nemo quibusdam? Lorem ipsum dolor
                sit amet consectetur adipisicing elit. Illo qui hic ex iste
                cumque rerum eligendi accusamus culpa earum? Placeat quibusdam
                natus non cum quod recusandae veniam dicta quidem maiores?
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bloco-sobre-um">
              ...
              <div className="texto-bloco-container">
                <p className="texto-bloco">
                  ...
                  quis quae commodi eos magnam repellendus nulla nobis, aliquam
                  ut aliquid fugiat, dolore deleniti.
                </p>
              </div>
            </div>
          </div>
