...
const CustomNextArrow = (props) => {
  ...
  return (
    <button
      onClick={onClick}
      className="absolute -right-4 top-1/2 transform -translate-y-1/2 z-10 bg-[#38BDF8] hover:bg-[#30aadd] text-yellow-400 p-2 rounded-full shadow-lg transition-all hidden md:block"
    >
...
const CustomPrevArrow = (props) => {
  ...
  return (
    <button
      onClick={onClick}
      className="absolute -left-4 top-1/2 transform -translate-y-1/2 z-10 bg-[#38BDF8] hover:bg-[#30aadd] text-yellow-400 p-2 rounded-full shadow-lg transition-all hidden md:block"
    >
