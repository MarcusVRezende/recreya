    ...
    return (
        <div className="!max-w-[1000px] !mx-auto !px-5 !py-10 !flex flex-col md:flex-row items-center !gap-10 font-sans antialiased">
            ...
            <div className="!flex-1 !text-center md:text-left flex flex-col !items-center md:items-start font-sans">
                ...
                <p className="text-lg leading-relaxed !mb-10 text-slate-600 max-w-md md:max-w-[90%] mx-auto md:mx-0 font-medium">
Ficou com alguma dúvida ou quer garantir o seu agendamento? Clique no botão abaixo e fale diretamente com a nossa equipe de forma rápida!                </p>
